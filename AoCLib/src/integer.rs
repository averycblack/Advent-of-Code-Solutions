//! Copied from https://github.com/maneatingape/advent-of-code-rust/blob/main/src/util/integer.rs
...
use std::ops::{Add, BitAnd, BitOr, Div, Mul, Neg, Rem, Shr, Sub, SubAssign};
